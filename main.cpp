...
// Извиняюсь, я пал в неравной битве с cmake в попытках собрать protobuf и забыл что не сдал предыдщуий спринт!

// Я не знаю, честно говоря, что это за магическое число, оно было в заготовке кода - тесты были даны в задании
